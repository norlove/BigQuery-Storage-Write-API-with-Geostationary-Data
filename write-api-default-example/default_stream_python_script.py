...
if __name__ == "__main__":
    ...
    BigQueryStorageWriteAppend.append_rows_proto2("my_project","temp", "example_geospatial",data=data) # Change this to your specific BigQuery project, dataset, table details
